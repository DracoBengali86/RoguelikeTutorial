...
class Entity:
    ...
    def move(self, dx, dy):
        # Move the entity by a given amoung
        self.x += dx
        self.y += dy
    ...
    def move_astar(self, target, entities, game_map):
        # http://www.roguebasin.com/index.php?title=Complete_Roguelike_Tutorial,_using_Python%2Blibtcod,_extras#A.2A_Pathfinding
        ...
        # It makes sense to keep path size relatively low to keep the monsters from running around the map if there's an alternate path really far away
