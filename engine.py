# Tutorial is here: http://www.roguebasin.com/index.php?title=Complete_Roguelike_Tutorial,_using_python%2Blibtcod
# new Tutorial for tcod on Python 3: http://rogueliketutorials.com/tutorials/tcod/part-1/
# replace libtcod with tcod in code (they import tcod as libtcod for backward compatibility)
import tcod
        ...
        for player_turn_result in player_turn_results:
            ...
            if dead_entity:
                if dead_entity == player:
                    message, game_map = kill_player(dead_entity)
                else:
