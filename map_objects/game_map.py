    ...
    def make_map(self, max_rooms, room_min_size, room_max_size, map_width, map_height, player, entities):
        ...
        for r in range(max_rooms):
            ...
            for other_room in rooms:
                ...
                # center coordinates of new room, wil be usefull later
                ...
                if item_choice == 'healing_potion':
                    ...
                    item_component = Item(use_function=cast_fireball, targeting=True, targeting_message=Message(
                        'Left-click a target tile for the fireball, or right-click to cancel.', tcod.light_cyan),
                                          damage=25, radius=3)
                    item = Entity(x, y, '#', tcod.red, 'Fireball Spell', render_order=RenderOrder.ITEM,
                                  item=item_component)
                elif item_choice == 'confusion_scroll':
                    item_component = Item(use_function=cast_confuse, targeting=True, targeting_message=Message(
                        'Left-click and enemy to confuse it, or right-click to cancel.', tcod.light_cyan))
